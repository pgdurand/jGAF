...
public class EZEnvironment {
	 ...
	 * refer to {@link EZEnvironment#addResourceLocator(Class)}
	 * methods.
	 * 
	 * @param key image key.
	 */
	...
	/**
	 * Sets the application main frame. For internal use only: this method is automatically
	 * called by the Generic Application Framework when creating the application main frame.
	 */
	public static void setParentFrame(Frame compo){
		EZEnvironmentImplem.setParentFrame(compo);
	}
	/**
	 * Sets the application command-line arguments. For internal use only: this method is automatically
	 * called by the Generic Application Framework at startup.
	 */
     ...
     * 
     * @param parent parent of this dialogue box. Either another dialogue box or the main frame. Passing
     * null is authorized; in that case, the main frame is considered as the parent of the dialogue box.
     * @param msg message
	...
	/**
	 * Figures out whether or not the application asks to user if the application can be closed. Default is true.
	 * Usually this method is called when implementing {@link EZDefaultActionHandler#handleExit()} method.
	 */
