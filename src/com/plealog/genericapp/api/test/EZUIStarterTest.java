...
public class EZUIStarterTest {
    ...
    public static void main(String[] args) {
		//this has to be done at the very beginning otherwise, it does not work at all !!!
      EZGenericApplication.initialize("EZUIStarterTest");
		...
		//see also EZDEfaultActionHandler to manage About, Preferences and Exit standard actions
		
		//to setup application branding, use class EZApplicationBranding before calling startApplication()
    ...
    private static class MyStarteListener implements EZUIStarterListener {
		...
		public void postStart() {
			...
			MyPro mp = new MyPro();
			EZEnvironment.getActionsManager().addActionMenuListener(mp);
		}
    ...
    private static class MyPro implements PropertyChangeListener {

		@Override
		public void propertyChange(PropertyChangeEvent event) {
			if (event.getPropertyName().equals("ActionFileOpen")){
				File f;
