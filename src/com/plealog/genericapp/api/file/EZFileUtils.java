...
public class EZFileUtils {
	...
	/**
	 * Check whether or not a path terminates with a separator. If not, this method
	 * returns a path ending with such separator.
	 */
	...
	/**
	 * Returns the content of a file as text. This method should be used only
	 * with text files.
	 * */
	 ...
	 * denotes a directory, then the last element of the absolute path is returned.
	 * It path denotes a file, then the last element of the absolute path is returned
	 * but without its extension (if any). The file extension is recognized by looking
	 * for the last occurrence of a dot. Note that the method may return null if no
