...
public class EZFormTreeTest {
	private static final String cfgPath = "/Users/pdurand/Documents/workspace_kepler/EZCrawler/conf/";
	...
	public static void main(String[] args) {
		...
		try {
	        ...
	        //PreferenceSystem.setUserInformation("Patrick Durand", "L8P78-A5RL7-J4YP2-F3BBZ-7W57Y");
	        model = PreferenceModelFactory.getModel(cfgPath+"editor.desc");
	        //editor = new ConfigurationPanel(model);
